...
\centering
\small
\caption{Ablation: SFT warm-start effect on GRPO\\(step 80, 266 questions).}
\label{tab:grpo_ablation_sft}
\begin{tabular}{@{}lccc@{}}
\toprule
Init & Acc. & $\Delta$ & Waste \\
\midrule
Fresh LoRA & 50.8\% & $+$0.4 & 29.3\% \\
\textbf{SFT fold\_4} & \textbf{57.9\%} & $\boldsymbol{+7.5}$ & 23.1\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}lccc@{}}
\toprule
LR & Waste & Attempts & Best Acc. \\
\midrule
$5\!\times\!10^{-6}$ & 21.3\% & 254 & Pending \\
$\boldsymbol{1\!\times\!10^{-5}}$ & 23.1\% & 260 & \textbf{57.9\%} \\
$2\!\times\!10^{-5}$ & 20.9\% & 253 & Pending \\
\bottomrule
\end{tabular}
\end{table}
